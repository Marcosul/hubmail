          ...
          <DataListPagination
            summary={
              <span className="text-xs">
                {copy.pageCount.replace("{count}", String(list.length))}
              </span>
            }
          />
        }
              ...
              {isLoading && list.length === 0 ? (
                ...
                <tr>
                  <td colSpan={3} className="px-4 py-10 text-center text-neutral-500 dark:text-neutral-500">
                    {searchQuery ? `Nenhum workspace encontrado para "${searchQuery}"` : copy.empty}
                  </td>
                </tr>
              ) : (
                list.map((workspace) => {
                  ...
                  const menuItems: ActionMenuItem[] = [
                    {
                      ...
                      icon: Pencil,
                      disabled: !isAdmin,
                      onClick: () => setDialog({ kind: "settings", workspace }),
                    },
                    {
                      key: "share",
                      ...
                      icon: Share2,
                      disabled: !isAdmin,
                      onClick: () => setDialog({ kind: "members", workspace }),
                    },
                    {
                      key: "delete",
